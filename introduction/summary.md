...
The Birkhoff-von Neumann (BvN) decomposition of a stochastic matrix writes a bistochastic matrix $M$ (nonnegative matrix which columns and rows sum to one) as a minimal number of permutation matrices $P_i$,
