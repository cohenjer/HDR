...
Blabla conclusif sur ce qui a été fait déjà

## Other topics

?
Wasserstein source sep
...
### Ability to address the research issues covered by the research theme 
KARP-COI contributes to the theory of convex and non-convex, non-smooth numerical optimization. It also contributes to unsupervised learning by improving available methods, benchmarks and software for NMF-KL. KARP-COI extends the state of the art on hybrid methods for inverse problems, leveraging scarce training dataset, and feeds on interactions between machine-learning/numerical optimization and computational imaging/music information retrieval. NMF-KL and data-driven variants are instances of interpretable AI models, built from model-based algorithms with theoretical guarantees.
...
Perspectives many:
- Acquisition patterns, acquisition subsampling
- Joint reconstruction and unmixing with deep priors (PaP, Unrolling)
- Better algorithms for KL
- Poisson-Gaussian noise [refs Chouzenoux]
- Poisson approximations for high count
